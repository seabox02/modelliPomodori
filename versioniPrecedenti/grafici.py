...
files_medium_26 = {
    '1. large (150 ep)': 'runs/segment26/large/modello26_large_150_64/results.csv',
    '2. 32 batch (150 ep)': 'runs/segment26/extraLarge/modello26_extraLarge_150/results.csv',
...
# Salvo l'immagine
output_filename = 'evolution_chart_confronto.png'
